            ...
            <div className="settings-security-item__row">
              <div className="settings-security-item__identity">
                <span className="settings-security-item__icon" aria-hidden style={{ display: 'inline-flex', alignItems: 'center' }}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-key-round" style={{ color: 'var(--warning, #f59e0b)' }}><path d="M2.586 17.414A2 2 0 0 0 2 18.828V21a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-1a1 1 0 0 1 1-1h1a1 1 0 0 0 1-1v-1a1 1 0 0 1 1-1h.172a2 2 0 0 0 1.414-.586l.828-.828A5 5 0 1 0 3.414 11l-.828.828z"/><circle cx="17" cy="7" r="1"/></svg>
                </span>
