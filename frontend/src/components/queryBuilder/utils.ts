...
export function orderByFieldOptions(dims: SemanticDimension[], metrics: SemanticMetric[], t: Translate) {
...
export function filterFieldOptions(dims: SemanticDimension[], metrics: SemanticMetric[], t: Translate) {
