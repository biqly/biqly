...
export function Modal({
  ...
  return (
    <div
      className="fixed inset-0 z-(--z-modal,1000) grid [place-items:start_center] overflow-y-auto bg-black/55 backdrop-blur-xs p-[3rem_1rem] max-[680px]:p-4 animate-modal-fade"
      role="presentation"
      tabIndex={-1}
      onClick={(event) => {
      ...
      >
        ...
        >
          <div className="flex flex-col min-w-0">
            ...
            {subtitle && (
              <p className="m-0 mt-[0.2rem] text-foreground-muted text-[0.86rem] leading-[1.45] wrap-anywhere">
                {subtitle}
              </p>
            )}
          </div>
