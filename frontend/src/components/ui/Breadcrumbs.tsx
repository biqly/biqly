            ...
            <Fragment key={index}>
              <li className="inline-flex min-w-0">
                {item.onClick && !isLast ? (
                  <button
                    type="button"
                    className="cursor-pointer border-0 bg-transparent p-0 font-medium text-foreground font-[inherit] [font-size:inherit] leading-[inherit] hover:text-accent hover:underline"
