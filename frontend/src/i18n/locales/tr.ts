...
export const tr: Dictionary = {
  ...
  modeling: {
    ...
    change_base_body: 'Bu base tablodur. Kaldırmadan önce yeni base seçin.',
  ...
  auth: {
    ...
    invite_resend_confirm: 'Bu daveti yeniden göndermek istediğinizden emin misiniz? Yeni bir bağlantı oluşturulacak ve e-posta gönderilecektir.',
