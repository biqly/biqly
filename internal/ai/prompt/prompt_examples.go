...
func (*Builder) writeDialectCompilationGuide(sb *bytes.Buffer, targetDialect string) {
...
func (*Builder) writeFailureExamples(sb *bytes.Buffer) {
...
func (*Builder) writePlanningSteps(sb *bytes.Buffer) {
